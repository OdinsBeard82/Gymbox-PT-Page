    ...
    return (
      <div className="pt">
        ...
        <div className="imagesText">
          ...
          <p>The Gymbox Academy works with some of the best coaches in London – each one bringing their unique personalities, specialist insight and expertise in club upon finishing training. Armed with the sharpest skills and latest techniques, choosing a Gymbox Personal Trainer means that whatever your goal, you’ll be in the safest (and strongest) hands around. 
